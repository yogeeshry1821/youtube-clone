        ...
        <div>
            <div className='grid p-2 mt-2 shadow-md grid-flow-col'>
                <div className='flex' >
                    ...
                    <a href="/">
                        <img alt="logo" className="h-5 cursor-pointer" src='https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/YouTube_Logo_2017.svg/640px-YouTube_Logo_2017.svg.png' />  
                    </a>
                                  
                </div>
                <div className='flex'>
                    <input placeholder='Search' 
                        className='p-2  w-full rounded-l-full border border-gray-400' 
                        type='text'
                        value={searchQuery}
